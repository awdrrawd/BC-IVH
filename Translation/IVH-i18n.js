...
(function () {
    ...
    const IVH_STRINGS = {
        ...
        // ── 載入 / 指令 ───────────────────────────────────────────────
	'loaded': {
	    TW: 'IVH v{v} 已載入 \n/ivh help 說明 | /ivh setting 設定頁 | /ivh show 效果測試\n首次使用或更新時記得前往設定頁檢查！',
	    CN: 'IVH v{v} 已加载 \n/ivh help 说明 | /ivh setting 设置页 | /ivh show 效果测试\n首次使用或更新时记得前往设置页检查！',
	    EN: 'IVH v{v} loaded \n/ivh help | /ivh setting | /ivh show test\nRemember to check the settings page on first use or after updates!',
	    JP: 'IVH v{v} 読み込み完了 \n/ivh help | /ivh setting | /ivh show テスト\n初回使用時・更新後は設定ページをご確認ください！',
	    KR: 'IVH v{v} 로드됨 \n/ivh help | /ivh setting | /ivh show 테스트\n처음 사용하거나 업데이트 후 설정 페이지를 확인하세요!',
        ...
        'remoteEditTitle': { TW: '編輯 {name} 的 IVH 文本', CN: '编辑 {name} 的 IVH 文本', EN: 'Edit {name}\'s IVH text', DE: 'IVH-Text von {name} bearbeiten', FR: 'Modifier le texte IVH de {name}', RU: 'Изменить IVH-текст {name}', UA: 'Редагувати IVH-текст {name}' },
        ...
        'profileEditBtn': { TW: '編輯對方的 IVH 文本', CN: '编辑对方的 IVH 文本', EN: 'Edit their IVH text', DE: 'Ihren IVH-Text bearbeiten', FR: 'Modifier son texte IVH', RU: 'Изменить их IVH-текст', UA: 'Редагувати їхній IVH-текст' },
